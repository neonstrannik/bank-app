 ...
 <section id="about" className="offers container">
            ...
            <div className="offer-cards">
              <div className="card offer-card">
                <h3>Миссия</h3>
                <p>
                  Мы создаём цифровой банк, который упрощает финансовую жизнь клиентов и делает
                  современные технологии доступными каждому.
                </p>
              </div>
              <div className="card offer-card">
                <h3>Надёжность</h3>
                <p>
                  V-Банк работает по международным стандартам безопасности, гарантируя защиту ваших
                  средств и данных.
                </p>
              </div>
              <div className="card offer-card">
                <h3>Инновации</h3>
                <p>
                  Используем искусственный интеллект для персонализированных финансовых решений и
                  анализа трат.
                </p>
              </div>
            </div>
          ...
          <section id="reviews" className="offers container">
            ...
            <div className="offer-cards">
              <div className="card offer-card">
                <h3>Марина, 28 лет</h3>
                <p>
                  Очень удобное приложение, переводы между картами моментальные! Пользуюсь уже год —
                  ни одного сбоя.
                </p>
              </div>
              <div className="card offer-card">
                <h3>Игорь, 35 лет</h3>
                <p>
                  Кэшбэк реально начисляют, поддержка отвечает быстро. Открыл счёт за 5 минут без
                  визита в офис.
                </p>
              </div>
              <div className="card offer-card">
                ...
                <p>
                  Кредитная карта с льготным периодом спасает. Всё прозрачно, без мелкого шрифта и
                  скрытых комиссий.
                </p>
              </div>
            </div>
  ...
  <div className="footer-inner container">
    ...
    <div className="footer-right">
      <a href="https://t.me/vbank" target="_blank" rel="noopener noreferrer">
        Telegram
      </a>
      <span>•</span>
      <a href="https://vk.com/vbank" target="_blank" rel="noopener noreferrer">
        VK
      </a>
    </div>
  </div>
